...
public class fabtitlebtn extends Button {
	private String Myfaburi;
	 private Button	fabimg1;
		Animation	subhide  ;
		Animation subshow;
		private BroadcastReceiver munhidefab;
		private BroadcastReceiver mhidefab;
		
	public fabtitlebtn (final Context c, AttributeSet attrs) {
		super(c, attrs);
		// TODO Auto-generated constructor stub
		fabimg1 =  (this);
		this.subhide  = AnimationUtils.loadAnimation(c.getApplicationContext(), R.anim.hidebuttonsubfab);
		   this.subshow =AnimationUtils.loadAnimation(c.getApplicationContext(), R.anim.buttonsubfab);
